...
const Sidebar = ({ isSidebarOpen, onClose }) => {
  ...
  const adminLinks = [
    ...
    { icon: MessageSquare, label: 'SMS logs', path: '/admin/sms-logs' },
    { icon: ShieldCheck, label: 'Roles & perms', path: '/admin/roles' },
    { icon: LayoutIcon, label: 'Notif. templates', path: '/admin/notification-templates' },
